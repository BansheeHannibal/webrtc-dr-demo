...
var zg,
  ...
  _config = {
    ...
    "nickName": 'u' + now,
    //"server": serverEnv.h5,
    "dispatchSever": 'https://experience.zegonetwork.com:15443/dispatch/connection',
    "logLevel": 0,
    "logUrl": "",
    "remoteLogLevel": 0,
    "roomFlag": true,
...
let apiDomain = "https://record.zegonetwork.com:20001";
recordConfig = {
  remoteUserid: '',
...
function openHall() {
  tokenUrl = "https://test.zegonetwork.com:543/logintoken";
...
$(function () {
  ...
  $('#extraInfo').click(function () {
    zg.updateStreamExtraInfo(streamId, $('#publishExtra').val());
  });
